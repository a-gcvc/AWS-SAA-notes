...
**Scearios** for use:
- if you find yourself having performance issues durign sale periods, or have specific tables or items in a table where there are heavy read workloads against that area of data - DAX
