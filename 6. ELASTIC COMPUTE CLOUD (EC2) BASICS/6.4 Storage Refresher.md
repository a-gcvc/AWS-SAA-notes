...
- **Persistent** Storage: storage whcih exists as its own thing; it lives on past the lifetime of the device that it's attached to (networrk attached storage deliveres by EBS)
