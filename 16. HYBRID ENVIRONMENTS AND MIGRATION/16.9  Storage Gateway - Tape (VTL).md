...
- Glacier Deep Archive is used for longer term data retention where you might never need to access the data again, but you need to keep it, maybe for legal reasons.
