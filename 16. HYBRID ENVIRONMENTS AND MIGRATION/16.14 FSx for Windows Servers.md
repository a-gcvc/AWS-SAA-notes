...
- VSS: Window feature that allows users to perform file and folder level restores. Unique to FSx and it means that if you have any users of Workspaces, if they use files and folders on an FSx share, and they right-click, they can view previous versions.
