...
- When S3 wants to encrypt an object using SEE-KMS it has to liaise with KMS and request a new data encryption key to be generated using the chosed KMS key.
