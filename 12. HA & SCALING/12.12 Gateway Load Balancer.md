...
Tunel is created betwenn Gateway load balancer and the backend instances, so the security appliances, packets are encapsulated and sent through this tunnel to the appliances
