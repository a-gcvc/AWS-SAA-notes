...
**Restore with a normal RDS will create a brand new database instance. It will have brand new database endpoint DNS name the CNAME and you will need to update any application configuration to this brand new database.**
