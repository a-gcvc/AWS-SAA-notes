...
1. You've got the instance size and type (the bigger and more feature-rich the instance, the greater the cost)
2. Choice of whether multi-AZ is used or not (multi-AZ means more than one instance there's going to be additional cost)
