...
- With Aurora Serverless you don't need to provision resources it the same way as you did with Aurora provisioned, you still creae a cluster but Aurora Serverless uses the concept of ACUs (Aurora Cpacity Units)
