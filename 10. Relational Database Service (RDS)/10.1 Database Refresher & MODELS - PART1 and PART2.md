...
**NoSQL**: tables are andled very differently
...
- **Wide Column Store** (DynamoDB):
    ...
    - offer groupings ot items called tables
...
- **Document** database:
    ...
    - documnets are structured using (JSON, XML)
    - work best for scenarios like order databases or collections or contanct style databases, interact with deep atributes 
