...
Every time a resource configuration changes, a configuration item is created which stores the condifuration of that resource at a specific point in time. 
