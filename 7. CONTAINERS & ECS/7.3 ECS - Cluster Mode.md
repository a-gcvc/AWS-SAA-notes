...
- Container instances are not something that's delivered as a managed service - they're just EC2 instances. 
...
- Containers make sense if you're just wanting to isolate your applications. (app which have: low level usage, all use the same OS, where you don't need overhead or virtualization)
