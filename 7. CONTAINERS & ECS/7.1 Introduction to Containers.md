...
- Layers used within images can be shared and images can be based off other images. Layer are read-only and an image is collection of layers group together, which can be shared and reused. 
