...
If you want to reuse a template, then you can choose to use nested stacks which allows you to use the same template that you've created once in many distinct architectures.
